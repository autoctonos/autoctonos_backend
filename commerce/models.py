...
class Pago(models.Model):
    ...
    estado = models.CharField(max_length=25, choices=ESTADO_PAGO_CHOICES, default='pendiente')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(default=None, null=True)
...
class Envio(models.Model):
    ...
    estado = models.CharField(max_length=255, choices=ESTADO_ENVIO_CHOICES, default='pendiente')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(default=None, null=True)
